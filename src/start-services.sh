...
main() {
  ...
  chmod 755 /app/nutify/core/events/ups_notifier.py
  chown nut:nut /app/nutify/core/events/ups_notifier.py
...
# Make sure Python log files have correct permissions
...
# Log directory permissions ensured
if [ "$ENABLE_LOG_STARTUP" = "Y" ]; then
